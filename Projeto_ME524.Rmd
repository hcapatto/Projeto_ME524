...
dado_ex=as.integer(database$hotel_cluster)

hist(dado_ex,breaks="Scott",main ="Frequência de hotel_clusters",xlab="Hoteis",ylab = "Frenquência",col="antiquewhite2",border = "black")
